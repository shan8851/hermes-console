  ...
  return (
    <div className="space-y-8">
      <section className="max-w-4xl">
        <div className="mb-4">
          <Link to="/cron" className="inline-flex items-center gap-2 rounded-full border border-border/80 bg-bg/40 px-3 py-1.5 font-mono text-xs text-fg-muted transition-colors hover:border-accent/60 hover:text-fg">
