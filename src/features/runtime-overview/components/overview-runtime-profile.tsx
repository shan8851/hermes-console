  ...
  return (
    <section className="rounded-xl border border-border bg-surface/70 p-4">
      <div className="mb-4">
        ...
        <p className="mt-2 text-sm leading-6 text-fg-muted">Curated defaults only. Enough to understand what this install will do without turning the homepage into a config dump.</p>
      </div>
